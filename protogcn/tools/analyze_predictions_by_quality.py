...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--predictions-csv", default="work_dirs/finetuning_conf/conf_internal_test_predictions.csv")
    parser.add_argument("--predictions-pkl", default="work_dirs/finetuning_conf/conf_internal_test_predictions.pkl")
    parser.add_argument("--output-dir", default="reports/conf")
    parser.add_argument("--prefix", default="conf_internal_test")
