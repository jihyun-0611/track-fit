...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dataset-pkl", default="data/datasets/dataset_v2.pkl")
    parser.add_argument("--split", default="internal_test")
    parser.add_argument("--scores-pkl", required=True)
    parser.add_argument("--split-report", default="data/splits/dataset_v2_split_report.csv")
    parser.add_argument("--label-mapping", default="data/datasets/dataset_v2_label_mapping.json")
    parser.add_argument("--output-csv", default="reports/internal_test_predictions.csv")
    parser.add_argument("--output-pkl", default="reports/internal_test_predictions.pkl")
